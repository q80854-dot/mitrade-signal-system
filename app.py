...
def update_all_data():
    ...
    try:
        ...
        logger.warning(f"macro_data: {e}")

    try:
        state.market_session = fetch_market_status()
    except Exception as e:
        logger.warning(f"market_status: {e}")

    try:
        state.fred_data = fetch_fred_data()
    except Exception as e:
        logger.debug(f"fred_data: {e}")
    ...
    try:
        ...
        logger.warning(f"system_status: {e}")
    ...
    try:
        ...
        def _startup():
            ...
            try:
                ...
                state.macro_data     = fetch_macro_data()
                state.market_session = fetch_market_status()
                logger.info("✅ 宏觀數據載入完成")
            except Exception as e:
                logger.error(f"宏觀數據失敗: {e}")
